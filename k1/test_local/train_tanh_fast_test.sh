...
cmd=run.pl
num_epochs=3      # Number of epochs during which we reduce
                   # the learning rate; number of iteration is worked out from this.
num_epochs_extra=0 # Number of epochs after we stop reducing
                   # the learning rate.
num_iters_final=3 # Maximum number of final iterations to give to the
