...
#feats="ark,scp,s,cs:$sdata/JOB/feats.scp ark:- |"
# feats="ark:copy-feats ark:$fftdir/raw_fft_train.$JOB.ark ark:- | "
feats="ark:copy-feats ark:$tmp_fft/new_fft.JOB.ark ark:- |"
...
feat_dim=`feat-to-dim scp:$PWD/fft/raw_fft_train.1.scp -`
